...
option_screen:
	...
	os_init_msg		db 'BIENVENIDO A HuguikeOS', 0
	os_version_msg		db 'Version ', MIKEOS_VER, 0

	dialog_string_1		db 'HuguikeOS inicializado correctamente, presione ok para continuar', 0
	dialog_string_2		db 'Por favor, selecciona una interfaz: OK para:', 0
	dialog_string_3		db 'Menu programa, Cancelar para la linea de comandos', 0
...
not_bas_extension:
	...
	kerndlg_string_1	db 'NO SE HA PODIDO CARGAR Y EJECUTAR KERNEL.BIN', 0
	kerndlg_string_2	db 'KERNEL.BIN ES EL NUCLEO DE HuguikeOS', 0
	kerndlg_string_3	db 'NO ES UN PROGRAMA NORMAL', 0

	ext_string_1		db 'EXTENSION INVALIDA DE ARCHIVO', 0
	ext_string_2		db 'LO SIENTO, SOLO SE PUEDE EJECUTAR PROGRAMAS .BIN  .BAS', 0

	basic_finished_msg	db '>>> PROGRAMA EN BASIC TERMINADO, PULSA CUALQUIER TECLA PARA CONTINUAR...', 0
